...
public class TesIntervalTree {
    ...
    public static void main(String[] args) throws NumberException {
        ArrayList<String> rawCompList= ParseDirFile("D:\\DataWater");
       // ArrayList<String> rawCompList= ParseCmop.readCmopCsv("D:\\DataWater\\saturn01.0.F.CT_2008_12_PD0.csv");
        double[] arrTemperature=ParseCmop.parseRawCompList(rawCompList,ParseCmop.printLog);
        //计算均值，标准差，最小值，最大值
        double[] statistics= ReadCSV.computeStatistics(arrTemperature);
        //划分范围，最大值，最小值
        ArrayList<HbaseIndexItem> listTem=new Pcam().computeHbaseSegmentAccordingSegment(arrTemperature,statistics[0],statistics[1],3);
        ...
        */
        ...
        double leftpoint =  34.689;
        double rightpoint =  34.888;
        //34.995, min=34.687
...

    {
       ...
       public  static ArrayList  ParseDirFile(String FilPath)
        {
